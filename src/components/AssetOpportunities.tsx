...
const AssetOpportunities: React.FC<AssetOpportunitiesProps> = ({
  ...
  return <div className="w-full">
      ...
      <div className="mb-12">
        ...
        <AssetOpportunitiesList selectedAssets={selectedAssets} onAssetToggle={handleAssetToggle} address={address} insights={insights} isLoading={isLoading} />

        {selectedAssets.length > 0 && <div className="flex justify-center mt-8">
            <button onClick={handleContinue} className="bg-[#AA94E2] hover:bg-[#9b87f5] text-[#FFFDED] px-8 py-4 text-lg rounded-full font-fahkwang transition-all shadow-md hover:shadow-lg">
      ...
      {showAdditionalInfo && <AssetAdditionalInfo selectedAssets={selectedAssets} onComplete={handleAuthWithGoogle} insights={insights} />}
    </div>;
};
