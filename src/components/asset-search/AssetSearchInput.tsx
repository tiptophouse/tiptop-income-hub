...
const AssetSearchInput: React.FC<AssetSearchInputProps> = ({
  ...
  useEffect(() => {
    ...
    console.log("Initializing Google Places Autocomplete for AssetSearchInput");
      ...
      try {
        ...
        autocompleteRef.current.addListener('place_changed', () => {
          ...
          if (place?.formatted_address) {
            console.log("Selected place in AssetSearchInput:", place.formatted_address);
            onAddressChange(place.formatted_address);
          }
        });
        
        setAutocompleteInitialized(true);
        console.log("AssetSearchInput autocomplete initialized");
      } catch (error) {
        console.error("Error initializing Google Places Autocomplete in AssetSearchInput:", error);
      }
    }, delay);
