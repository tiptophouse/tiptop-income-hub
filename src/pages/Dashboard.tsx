    ...
    <SidebarProvider>
      <div className="min-h-screen bg-background flex w-full">
        <Sidebar>
          ...
          <SidebarContent>
            <SidebarMenu>
              ...
              <SidebarMenuItem>
                <SidebarMenuButton 
                  isActive={selectedView === 'solar'} 
                  onClick={() => setSelectedView('solar')}
                >
              ...
              <SidebarMenuItem>
                <SidebarMenuButton 
                  isActive={selectedView === 'internet'} 
                  onClick={() => setSelectedView('internet')}
                >
        ...
        <SidebarInset>
          ...
          {selectedView === 'solar' && <SolarAssetDetail />}
