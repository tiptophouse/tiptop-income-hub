...
const Dashboard = () => {
  ...
  const [propertyJobId, setPropertyJobId] = useState<string | null>("demo-3d-model-1");
  const [propertyDescription, setPropertyDescription] = useState(
    "This elegant two-story home features solar panels on the roof, a spacious front porch, and a detached garage. " +
    "The property includes modern amenities and is well-maintained with excellent potential for asset monetization."
  );
