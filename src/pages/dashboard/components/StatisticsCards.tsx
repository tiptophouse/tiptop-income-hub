...
const StatisticsCards = ({ earnings, activeAssets, totalPotentialAssets, pendingActions }: StatisticsCardsProps) => {
  ...
  return (
    <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
      <Card>
        ...
        <CardContent className={isMobile ? 'p-4 pt-0' : 'p-6 pt-0'}>
          <div className="flex items-center">
            ...
            <div>
              <div className={`${isMobile ? 'text-xl' : 'text-2xl'} font-bold`}>${earnings.monthly}</div>
      ...
      <Card>
        <CardHeader className={`pb-2 ${isMobile ? 'p-4' : 'p-6'}`}>
          <CardTitle className={`${isMobile ? 'text-sm' : 'text-lg'} font-medium`}>Active Assets</CardTitle>
        ...
        <CardContent className={isMobile ? 'p-4 pt-0' : 'p-6 pt-0'}>
          <div className="flex items-center">
            ...
            <div>
              <div className={`${isMobile ? 'text-xl' : 'text-2xl'} font-bold`}>{activeAssets}/{totalPotentialAssets}</div>
      ...
      <Card>
        <CardHeader className={`pb-2 ${isMobile ? 'p-4' : 'p-6'}`}>
          <CardTitle className={`${isMobile ? 'text-sm' : 'text-lg'} font-medium`}>Pending Actions</CardTitle>
        ...
        <CardContent className={isMobile ? 'p-4 pt-0' : 'p-6 pt-0'}>
          <div className="flex items-center">
            ...
            <div>
              <div className={`${isMobile ? 'text-xl' : 'text-2xl'} font-bold`}>{pendingActions}</div>
