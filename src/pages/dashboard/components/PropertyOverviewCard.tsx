...
const PropertyOverviewCard = ({
  ...
  return <Card className="shadow-md hover:shadow-lg transition-shadow duration-300">
      ...
      <CardContent className={isMobile ? 'p-3 pt-0' : 'pt-0'}>
        {propertyAddress && <p className="text-sm text-muted-foreground">
        ...
        {!propertyAddress && <p className="text-sm text-muted-foreground">The property features a rooftop with good solar exposure, a rentable garden area, stable internet for bandwidth sharing, and available parking space. Nearby, neighbors are actively renting parking and garden spaces, showing strong local demand.</p>}
      </CardContent>
    </Card>;
};
